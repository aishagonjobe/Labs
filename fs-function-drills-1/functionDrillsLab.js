...
console.log(exclaimThree("no way"))
...
const nameGreeting = nameCheck("Cornelius Fudge")
...
const thatsOdd = number => number % 2 === 0 ? "That's not odd!" : "That's odd indeed!";
...
const totalFrogs = shopChocoFrogs(5);
...
const totalFrogs2 = shopChocoFrogs2(13)
...
const checkArrayOrder = (array) => {
  let isArraySorted = false;
  for (i = 0; i < array.length-1; i++){
    if (array[i] < array[i+1]){
      isArraySorted = true;
    } else {
      return isArraySorted = false;
    }
  }
  return isArraySorted;
}

const arrayIsAscending = checkArrayOrder(sampleArray);
